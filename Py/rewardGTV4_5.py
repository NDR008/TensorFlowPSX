...
class RewardFunction:
    def __init__(self,
        ...
        self.fudgeFactor = 40 #since the spacing of data points along the track may vary this scales the reward
        self.totalReward = 0
    ...
    def complexReward(self, pos, vColl, vSpeed, vDir):
        ...
        if vSpeed < 15:  # going slow is a bit bad Changed from 15 to 2
    ...
    def computeRewardPreStart(self, rpm, boost, steer):
        ...
        self.reward = rpm[0] / 100000 +  boost[0]/ 100000 - abs(steer[0])/(1024*2)
