...
from rewardGTV5_1 import RewardFunction
...
class MyGranTurismoRTGYM(RealTimeGymInterface):
    ...
    def getObs(self, reset):
        ...
        reward, self.terminated, future1, future2 = self.rewardFunction.computeReward(pos=self.vPosition, vColl=self.vColl, vDir=self.vDir, vSpeed=self.vSpeed, mode=self.rewardMode)     
