...
function load(file, analogue)
    ...
    file:close()
    setValue(mem, 0x800b6358, 1, 'int16_t*')
    setValue(mem, 0x800b6362, 1, 'int8_t*')
end
...
function netTCP(netChanged, netStatus, port)
    ...
    elseif netStatus then
        ...
        if tmp['raceState'] == 1 and not jumpControl then
                setValue(mem, 0x800b6d61, 2, 'int16_t*')
                takeControl = false
        elseif jumpControl and tmp['raceState'] == 1 then
        ...
        elseif readVal == 0 + 64 + 100 then            -- MR2 at HS
            load("mr2_0_0_0_0_2.slice", false)
            takeControl = true
        ...
        elseif readVal == 9 + 64 then             -- MR2 at Route5
            load("mr2_2_0_0_0.slice", true)
        elseif readVal == 9 + 64 + 100 then       -- MR2 at Route5
            load("mr2_2_0_0_0_2.slice", true)
            takeControl = true
        --midTrack
        elseif readVal == 22 + 10 + 64 then       -- MR2 at Route5
            load("mr2_2_0_0_0B.slice", false)
        elseif readVal == 22 + 10 + 64 + 100 then -- MR2 at Route5
            load("mr2_2_0_0_0_2.slice", false)
            takeControl = true
        elseif readVal == 22 + 64 then       -- MR2 at Route5
            load("mr2_2_0_0_0B.slice", true)
        elseif readVal == 22 + 64 + 100 then -- MR2 at Route5
            load("mr2_2_0_0_0_2.slice", true)
            takeControl = true
