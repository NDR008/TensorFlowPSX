...
function carInfo()
    if (imgui.CollapsingHeader("Car", ImGuiTreeNodeFlags_None)) then
        ...
        doSliderInt(mem, 0x800b66de, 'Brake2 (ABS1)', 0, 4096, 'int16_t*')
        doSliderInt(mem, 0x800b66e0, 'Brake3 (ABS2)', 0, 4096, 'int16_t*')
...
function funkyStuff()
    if (imgui.CollapsingHeader("Misc", ImGuiTreeNodeFlags_None)) then
        ...
        doSliderInt(mem, 0x800b6356, 'Camera Mode', 00, 02, 'int16_t*')
